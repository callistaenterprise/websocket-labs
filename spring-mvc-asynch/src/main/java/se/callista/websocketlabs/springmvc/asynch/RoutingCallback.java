...
public class RoutingCallback extends AsyncCompletionHandler<Response> {

    private static final Logger LOG = LoggerFactory.getLogger(RoutingCallback.class);

    private long reqId;
    private AtomicLong concurrentRequests;
    private DeferredResult<String> deferredResult;

    public RoutingCallback(long reqId, AtomicLong concurrentRequests, DeferredResult<String> deferredResult) {
        this.reqId = reqId;
