...
public class GpioPin {
	...
	private static final Logger LOG = LoggerFactory.getLogger(GpioPin.class);
	...
	public GpioPin(int pinNumber, Direction direction) {
		...
		LOG.info("Enabling GPIO pin #{} (physical: #{}), direction: {}", new Object[] {pinNumber, this.pinNumber, direction.getValue()});
